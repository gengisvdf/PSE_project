...
/*TEST_F(TestPrintSystem, checkAssignment) {
    ...
    const std::string regex = "Assertion failed: Geen apparaten gevonden, file C:/Users/adamb/CLionProjects/PSE-projectxe/src/PrintSystem.c\n"
                              "pp, line 124";
...
/*TEST_F(TestPrintSystem, cantOpen){
    const std::string regex = "Assertion failed: Bestand bestaat niet., file C:/Users/adamb/CLionProjects/PSE-projectxe/src/PrintSystem.cpp\n"
                              ", line 42";
